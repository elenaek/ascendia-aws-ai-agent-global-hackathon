...
class CompetitorOverview(BaseModel):
    ...
    website_url: str = Field(description="The website URL of the company. With the 'https://' or 'http://'")
    ...
    description: str = Field(description="The description of the company and what they do")
